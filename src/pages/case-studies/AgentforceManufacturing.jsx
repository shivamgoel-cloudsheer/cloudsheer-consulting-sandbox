...
function ArticleStyles() {
  return (
    <style>{`
      ...
      .cs-wrap { max-width: 760px; margin: 0 auto; padding-left: 1.5rem; padding-right: 1.5rem; }
      ...
      @media (min-width: 640px) { .cs-h1 { font-size: 3rem; } }
      @media (min-width: 1024px) { .cs-h1 { font-size: 3.5rem; } }
      ...
      @media (min-width: 640px) { .cs-dek { font-size: 1.3125rem; line-height: 1.55; } }
      ...
      @media (min-width: 640px) {
        .cs-body { font-size: 1.125rem; line-height: 1.78; }
      }
      .cs-body p { margin-bottom: 1.4em; }
      .cs-body strong { font-weight: 700; color: #0A0A0A; }
      .cs-body a { color: #0176D3; text-decoration: underline; text-underline-offset: 3px; }
      ...
      @media (min-width: 640px) {
        .cs-h2 { font-size: 1.875rem; margin-top: 4.5rem; }
      }
      ...
      @media (min-width: 640px) {
        .cs-pullquote { font-size: 1.625rem; }
      }
      .cs-pullquote-attr {
        display: block;
        margin-top: 0.875rem;
      ...
      @media (min-width: 640px) {
        .cs-list li { font-size: 1.125rem; }
      }
      .cs-list li::marker { color: #0176D3; }

      .cs-list-ordered { list-style: decimal; }
      ...
      .cs-rule { height: 1px; background: #D9D6CE; border: 0; margin: 4rem 0; }
      ...
      .cs-table td.after { font-weight: 700; color: #059669; }
      .cs-table td.before { color: #DC2626; }
  ...
  return (
    <article className="case-study">
      <div className="cs-wrap" style={{ paddingTop: '7rem', paddingBottom: '5rem' }}>
        ...
        {/* Title block */}
        <header style={{ marginTop: '3rem', marginBottom: '3rem' }}>
        ...
        <div className="cs-body">
          ...
          <ul className="cs-list">
            <li><strong>Vendors</strong> sent structured submissions like receipts, invoices, customer details, and photos. That work needed structured extraction.</li>
            <li><strong>End customers</strong> sent incomplete conversations with missing order numbers, missing product details, and partial warranty data. That work needed conversational slot-filling.</li>
          </ul>
          ...
          <ul className="cs-list">
            <li><strong>ConnectApiWrapper</strong> owns all live LLM execution. It is a centralized, fully audited execution path.</li>
            <li><strong>PromptService</strong> standardizes payload structure and ensures consistency across every AI interaction.</li>
          </ul>

          <p>
            Every request flows through this layer: intent classification, summarization,
            warranty validation, and email drafting. In production, mean LLM latency runs
            under <strong>1.4 seconds</strong>. Fast enough that customer interactions feel
            instant.
          </p>
          ...
          <ul className="cs-list">
            <li>Case operations scoped to vendor portfolios.</li>
            <li>OCR and LLM receipt extraction.</li>
            <li>Attachment parsing.</li>
            <li>Predictable JSON normalization.</li>
          </ul>
          <p>Vendor receipt processing runs end-to-end in under four seconds.</p>

          <p>
            <strong>The B2C Specialist</strong> is purpose-built for conversational support
            and slot-filling. Its capabilities include:
          </p>
          <ul className="cs-list">
            <li>Warranty validation.</li>
            <li>Product Q&amp;A.</li>
            <li>Manual retrieval.</li>
            <li>Case history retrieval.</li>
          </ul>
          <p>
            Seventy-eight percent of customer interactions now resolve in a single contact
          ...
          <p>
            ...
            against it in real time. The AI returns a deterministic result of either covered
            or expired. Manual lookup used to take six minutes per case. Autonomous
            validation now runs in three seconds with a 99.4% match rate against the
            source-of-truth catalog.
          </p>

          <p>
            Salesforce said this couldn't be grounded reliably against free-form Excel
            data. In production, it works at scale.
          </p>
          ...
          <p>
            ...
            focused services. Each service does one job, uses one prompt, and follows one
            execution path:
          </p>
          ...
          <ul className="cs-list cs-mono">
            ...
            <li>CustomerRecordService, for customer matching and record creation.</li>
            <li>PromptService, for centralized prompt execution.</li>
          </ul>

          <p>The result was roughly <strong>1,800 lines of brittle Apex retired.</strong></p>
          ...
          <ul className="cs-list">
            <li>The AI step is bypassed.</li>
            <li>The case routes directly to a human.</li>
            <li>Routing completes in under five seconds.</li>
          </ul>
          ...
          <ul className="cs-list">
            <li>Pre-delegation safety validation on every agent handoff.</li>
            <li>UUID crash protection inside ApexAgentUtils.cls.</li>
            <li>Einstein Trust Layer enforcement on all grounding and policy checks.</li>
            <li>Operator Trap Doors on every critical invocable.</li>
          </ul>
          ...
          <p>
            ...
            Agentforce implementations skip this entirely. We shipped:
          </p>

          <ul className="cs-list">
            <li>IntentWrapperMock.</li>
            <li>Reusable mock frameworks.</li>
            <li>Universal Apex harness coverage.</li>
            <li>Regression coverage across every named agent path.</li>
          </ul>

          <p>The result was <strong>94% Apex test coverage at deployment.</strong></p>
          ...
          <table className="cs-table">
            ...
            <tbody>
              <tr><td>Autonomous case resolution</td><td className="before tnum">0%</td><td className="after tnum">92%</td></tr>
              <tr><td>Triage time per email</td><td className="before tnum">~8 min</td><td className="after tnum">~14 sec</td></tr>
              <tr><td>Time to first response</td><td className="before tnum">~14 hrs</td><td className="after tnum">&lt;90 sec</td></tr>
              <tr><td>First-contact resolution</td><td className="before tnum">31%</td><td className="after tnum">78%</td></tr>
              <tr><td>Manual escalation rate</td><td className="before tnum">100%</td><td className="after tnum">17%</td></tr>
              <tr><td>Warranty validation</td><td className="before tnum">~6 min</td><td className="after tnum">~3 sec</td></tr>
              <tr><td>CSAT (rolling 90-day)</td><td className="before tnum">64</td><td className="after tnum">86</td></tr>
              <tr><td>Emails handled per month</td><td className="before">Manual</td><td className="after tnum">12,000+</td></tr>
              <tr><td>FTEs redeployed</td><td className="before">N/A</td><td className="after">4</td></tr>
              <tr><td>Annual labor cost avoided</td><td className="before">N/A</td><td className="after tnum">~$340K</td></tr>
              <tr><td>User-facing errors since launch</td><td className="before">N/A</td><td className="after">0</td></tr>
              <tr><td>Time to production</td><td className="before">N/A</td><td className="after">11 weeks</td></tr>
            </tbody>
          </table>
