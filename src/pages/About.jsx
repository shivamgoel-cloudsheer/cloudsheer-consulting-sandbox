...
const team = [
  ...
  { id: 15, name: 'Arun Kumar',           role: 'Salesforce Developer',              photo: BASE + 'team/Arun Kumar.JPG',           linkedin: '#' },
  { id: 16, name: 'Divyansh Sharma',      role: 'Salesforce Developer',              photo: BASE + 'team/Divyansh Sharma.jpg',      linkedin: '#' },
  { id: 17, name: 'Gaurav Khanna',        role: 'Salesforce Developer',              photo: BASE + 'team/Gaurav Khanna.JPG',        linkedin: '#' },
  { id: 18, name: 'Piyush Kumar Singh',   role: 'Salesforce Developer',              photo: BASE + 'team/Piyush Kumar Singh.JPG',   linkedin: '#' },
  { id: 19, name: 'Rahul Babbar',         role: 'Salesforce Developer',              photo: BASE + 'team/Rahul Babbar.jpg',         linkedin: '#' },
